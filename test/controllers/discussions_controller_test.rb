...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { image: @discussion.image, owner: @discussion.owner, topic: @discussion.topic } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { image: @discussion.image, owner: @discussion.owner, topic: @discussion.topic } }
